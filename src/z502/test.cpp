...
void test1b(void) {
	...
	while (1) {
		...
		STEP( 0)
			...
			CREATE_PROCESS( "test1b_a", test1x, ILLEGAL_PRIORITY, &Z502_REG_1, &Z502_REG_9);
		...
		STEP( 1)
			...
			CREATE_PROCESS( "two_the_same", test1x, LEGAL_PRIORITY, &Z502_REG_2, &Z502_REG_9);

		STEP( 2)
			success_expected(Z502_REG_9, "CREATE_PROCESS");
			CREATE_PROCESS( "two_the_same", test1x, LEGAL_PRIORITY, &Z502_REG_1, &Z502_REG_9);
		STEP( 3)
			error_expected(Z502_REG_9, "CREATE_PROCESS");
		...
		STEP( 5)
			...
			CREATE_PROCESS( process_name, test1x, LEGAL_PRIORITY, &Z502_REG_1, &Z502_REG_9);
...
void test1c(void) {
	...
	while (1) {
		...
		STEP( 0)
			...
			CREATE_PROCESS( "test1c_a", test1x, PRIORITY1C, &Z502_REG_1, &Z502_REG_9);

		STEP( 1)
			success_expected(Z502_REG_9, "CREATE_PROCESS");
			CREATE_PROCESS( "test1c_b", test1x, PRIORITY1C, &Z502_REG_2, &Z502_REG_9);

		STEP( 2)
			CREATE_PROCESS( "test1c_c", test1x, PRIORITY1C, &Z502_REG_3, &Z502_REG_9);

		STEP( 3)
			CREATE_PROCESS( "test1c_d", test1x, PRIORITY1C, &Z502_REG_4, &Z502_REG_9);

		STEP( 4)
			CREATE_PROCESS( "test1c_e", test1x, PRIORITY1C, &Z502_REG_5, &Z502_REG_9);
		...
		STEP( 10)
			printf("Test1c, PID %ld, Ends at Time %ld\n", Z502_REG_2, Z502_REG_4);
...
void test1d(void) {
	...
	while (1) {
		...
		STEP( 0)
			...
			CREATE_PROCESS( "test1d_1", test1x, PRIORITY1, &Z502_REG_1, &Z502_REG_9);

		STEP( 1)
			success_expected(Z502_REG_9, "CREATE_PROCESS");
			CREATE_PROCESS( "test1d_2", test1x, PRIORITY2, &Z502_REG_2, &Z502_REG_9);

		STEP( 2)
			CREATE_PROCESS( "test1d_3", test1x, PRIORITY3, &Z502_REG_3, &Z502_REG_9);

		STEP( 3)
			CREATE_PROCESS( "test1d_4", test1x, PRIORITY4, &Z502_REG_4, &Z502_REG_9);

		STEP( 4)
			CREATE_PROCESS( "test1d_5", test1x, PRIORITY5, &Z502_REG_5, &Z502_REG_9);
...
void test1e(void) {
	...
	STEP( 1) /* Make legal target    */
		...
		CREATE_PROCESS( "test1e_a", test1x, LEGAL_PRIORITY_1E, &Z502_REG_1, &Z502_REG_9);
...
void test1f(void) {
	...
	STEP( 1) /* Make legal target    */
		...
		CREATE_PROCESS( "test1f_a", test1x, PRIORITY_1F1, &Z502_REG_3, &Z502_REG_9);

	STEP( 2) /* Make legal target    */
		CREATE_PROCESS( "test1f_b", test1x, PRIORITY_1F2, &Z502_REG_4, &Z502_REG_9);

	STEP( 3) /* Make legal target    */
		CREATE_PROCESS( "test1f_c", test1x, PRIORITY_1F3, &Z502_REG_5, &Z502_REG_9);

	STEP( 4) /* Make legal target    */
		CREATE_PROCESS( "test1f_d", test1x, PRIORITY_1F4, &Z502_REG_6, &Z502_REG_9);

	STEP( 5) /* Make legal target    */
		CREATE_PROCESS( "test1f_e", test1x, PRIORITY_1F5, &Z502_REG_7, &Z502_REG_9);
...
void test1g(void) {
	...
	STEP( 1) /* Make legal target    */
		...
		CREATE_PROCESS( "test1g_a", test1x, LEGAL_PRIORITY_1G, &Z502_REG_1, &Z502_REG_9);
...
void test1h(void) {
	...
	STEP( 2) /* Make legal targets   */
		CREATE_PROCESS( "test1h_a", test1x, NORMAL_PRIORITY, &Z502_REG_3, &Z502_REG_9);

	STEP( 3) /* Make legal targets   */
		CREATE_PROCESS( "test1h_b", test1x, NORMAL_PRIORITY, &Z502_REG_4, &Z502_REG_9);

	STEP( 4) /* Make legal targets   */
		CREATE_PROCESS( "test1h_c", test1x, NORMAL_PRIORITY, &Z502_REG_5, &Z502_REG_9);
...
void test1i(void) {
	...
	while (1) {
		...
		STEP( 2) /* Make legal targets  */
			CREATE_PROCESS( "test1i_a", test1x, NORMAL_PRIORITY, &Z502_REG_3, &Z502_REG_9);
		...
		STEP( 5)
			...
			RECEIVE_MESSAGE( td->source_pid, td->msg_buffer, td->receive_length, &(td->actual_send_length), &(td->actual_source_pid), &Z502_REG_9);
		...
		STEP( 7)
			...
			SEND_MESSAGE( td->target_pid, "a long but legal message", td->send_length, &Z502_REG_9);
...
void test1j(void) {
	...
	while (1) {
		...
		STEP( 2) /* Make legal targets  */
			...
			CREATE_PROCESS( "test1j_1", test1j_echo, NORMAL_PRIORITY, &Z502_REG_3, &Z502_REG_9);

		STEP( 3) /* Make legal targets  */
			success_expected(Z502_REG_9, "CREATE_PROCESS");
			CREATE_PROCESS( "test1j_2", test1j_echo, NORMAL_PRIORITY, &Z502_REG_4, &Z502_REG_9);

		STEP( 4) /* Make legal targets  */
			success_expected(Z502_REG_9, "CREATE_PROCESS");
			CREATE_PROCESS( "test1j_3", test1j_echo, NORMAL_PRIORITY, &Z502_REG_5, &Z502_REG_9);
...
void test1l(void) {
	...
	while (1) {
		...
		STEP( 2) /* Make process to test with  */
			success_expected(Z502_REG_9, "CHANGE_PRIORITY");
			CREATE_PROCESS( "test1l_1", test1j_echo, NORMAL_PRIORITY, &Z502_REG_3, &Z502_REG_9);
		...
		STEP( 9)
			...
			CREATE_PROCESS( "test1l_2", test1j_echo, NORMAL_PRIORITY, &Z502_REG_5, &Z502_REG_9);
...
void test1m(void) {
	...
	while (1) {
		...
		STEP( 0)
			...
			CREATE_PROCESS( "test1m_1", test1x, PRIORITY1, &Z502_REG_1, &Z502_REG_9);

		STEP( 1)
			success_expected(Z502_REG_9, "CREATE_PROCESS");
			CREATE_PROCESS( "test1m_2", test1x, PRIORITY1, &Z502_REG_2, &Z502_REG_9);

		STEP( 2)
			CREATE_PROCESS( "test1m_3", test1x, PRIORITY2, &Z502_REG_3, &Z502_REG_9);

		STEP( 3)
			CREATE_PROCESS( "test1m_4", test1x, PRIORITY2, &Z502_REG_4, &Z502_REG_9);

		STEP( 4)
			CREATE_PROCESS( "test1m_5", test1x, PRIORITY3, &Z502_REG_2, &Z502_REG_9);

		STEP( 5)
			CREATE_PROCESS( "test1m_6", test1x, PRIORITY3, &Z502_REG_3, &Z502_REG_9);

		STEP( 6)
			CREATE_PROCESS( "test1m_7", test1x, PRIORITY4, &Z502_REG_4, &Z502_REG_9);
...
#define         NUMBER_OF_TEST1X_ITERATIONS     3
...
void test1j_echo(void) {
	...
	while (1) {
		...
		STEP( 2)
			td->source_pid = -1;
			td->receive_length = LEGAL_MESSAGE_LENGTH;
			RECEIVE_MESSAGE( td->source_pid, td->msg_buffer, td->receive_length, &(td->actual_senders_length), &(td->actual_source_pid), &Z502_REG_9);

		STEP( 3)
			success_expected(Z502_REG_9, "RECEIVE_MESSAGE");
			printf("Receive from PID = %d: length = %d: msg = %s:\n", td->actual_source_pid, td->actual_senders_length, td->msg_buffer);
...
void test2b(void) {
	static INT32 test_data[TEST_DATA_SIZE] = { 0, 4, PGSIZE - 2, PGSIZE, 3 * PGSIZE - 2, (VIRTUAL_MEM_PGS - 1) * PGSIZE, VIRTUAL_MEM_PGS * PGSIZE - 2 };
...
void test2c(void) {
	...
	while (1) {
		...
		STEP( 4)
			...
			if ((data_read->int_data[0] != data_written->int_data[0]) || (data_read->int_data[1] != data_written->int_data[1]) || (data_read->int_data[2] != data_written->int_data[2]) || (data_read->int_data[3] != data_written->int_data[3]))
				printf("AN ERROR HAS OCCURRED.\n");
...
void test2gx(void) {
	...
	while (1) {
		...
		STEP( 1)
			...
			DEFINE_SHARED_AREA( ld->starting_address_of_shared_area, ld->pages_in_shared_area, ld->area_tag, &ld->number_previous_sharers, &ld->error_returned);
...
//                SLEEP( 10 );
		...
		STEP( 6)
			...
			MEM_WRITE( MEM_ADJUST(proc_info[ld->our_index].structure_tag), &ld->memory_info);
...
//                SLEEP( 10 );
		...
		STEP( 15)
			...
			ld->our_index = ld->number_previous_sharers;
			MEM_READ( MEM_ADJUST(proc_info[ld->next_index].structure_tag), &ld->memory_info);
		...
		STEP( 16)
			...
			MEM_WRITE( MEM_ADJUST(proc_info[ld->next_index].mailbox), &ld->data_being_passed);

		STEP( 17)
			MEM_WRITE( MEM_ADJUST(proc_info[ld->next_index]. writer_of_mailbox), &Z502_REG_4);
		...
		STEP( 30)
			...
			RECEIVE_MESSAGE( ld->source_pid, ld->receive_buffer, ld->message_receive_length, &ld->message_send_length, &ld->message_sender_pid, &ld->error_returned);
...
//                SLEEP( 10 );
		...
		STEP( 33)
			MEM_READ( MEM_ADJUST(proc_info[ld->our_index].structure_tag), &ld->memory_info);
		...
		STEP( 34)
			...
			MEM_READ( MEM_ADJUST(proc_info[ld->our_index].mailbox), &ld->data_being_passed);

		STEP( 35)
			printf("\t\t\tReceiver %ld from Sender %d got data %d\n", Z502_REG_4, ld->message_sender_pid, ld->data_being_passed);
			MEM_READ( MEM_ADJUST(proc_info[ld->our_index]. writer_of_mailbox), &ld->memory_info);
		...
		STEP( 44)
			MEM_READ( MEM_ADJUST(proc_info[ Z502_REG_7].structure_tag), &ld->memory_info);

		STEP( 45)
			MEM_READ( MEM_ADJUST( proc_info[ Z502_REG_7].pid ), &Z502_REG_6);

		STEP( 46)
			MEM_READ( MEM_ADJUST( proc_info[ Z502_REG_7].mailbox ), &Z502_REG_2);

		STEP( 47)
			MEM_READ( MEM_ADJUST( proc_info[Z502_REG_7].writer_of_mailbox), &Z502_REG_3);
